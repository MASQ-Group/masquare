...
import { JiniusProductService } from './jinius/jinius-product.service';
...
@Module({
  ...
  providers: [ListingService, AmazonListingService, EbayListingService, OnbuyListingService, OnbuyImagesService, OnbuyContentService, JiniusListingService, JiniusProductService, ProductContentService, ListingPriceService, AvailabilitySweepService],
