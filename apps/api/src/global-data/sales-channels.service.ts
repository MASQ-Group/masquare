  ...
  create(dto: CreateSalesChannelDto, actorId?: string, companyId?: string) {
    return this.prisma.salesChannel.create({
      data: {
        ...
        shippingByChannel: dto.shippingByChannel ?? false,
        ...
        fxSpreadPct: dto.fxSpreadPct ?? null,
        fxSpreadNote: dto.fxSpreadNote ?? null,
        fxSpreadSetAt: dto.fxSpreadPct != null ? new Date() : null,
  ...
  async update(id: string, dto: UpdateSalesChannelDto, actorId?: string, companyIds?: string[]) {
    ...
    return this.prisma.salesChannel.update({
      ...
      data: {
        ...
        shippingByChannel: dto.shippingByChannel,
        ...
        fxSpreadPct: dto.fxSpreadPct,
        fxSpreadNote: dto.fxSpreadNote,
        // Stamped when the spread changes, so how stale it is can be seen at a glance.
        ...(dto.fxSpreadPct !== undefined ? { fxSpreadSetAt: dto.fxSpreadPct != null ? new Date() : null } : {}),
