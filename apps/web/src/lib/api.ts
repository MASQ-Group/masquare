...
export const shipmentsApi = {
  ...
  dispatchedElsewhere: (params: { q?: string; companyId?: string; salesChannelId?: string; channelKind?: 'local' | 'channel'; sortDir?: 'asc' | 'desc'; page?: number; pageSize?: number }) =>
    api.get<PendingListResponse>('/shipments/dispatched-elsewhere', { params }).then((r) => r.data),
  /** Close them out at the estimated cost, without inventing a shipment. */
  acceptChannelDispatch: (transactionIds: string[]) =>
