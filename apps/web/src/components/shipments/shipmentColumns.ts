...
export interface ShipmentColumn { key: string; label: string; sample: string; context?: boolean }
...
export const SHIPMENT_COLUMNS: ShipmentColumn[] = [
  ...
  { key: 'type', label: 'Type', sample: 'outbound' },
  ...
  { key: 'costBorneBy', label: 'Cost borne by', sample: 'company' },
  { key: 'dutyImportEur', label: 'Duty/import (EUR)', sample: '0.00' },
  { key: 'comments', label: 'Comments', sample: '' },
  { key: 'markShipped', label: 'Mark fully shipped', sample: 'yes' },
];
